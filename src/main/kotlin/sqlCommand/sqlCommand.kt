package dirtkai.mirai.plugin.sqlCommand
...
fun main() {
    ...
    Database.connect("jdbc:mysql://localhost:3306/test?serverTimezone=UTC", driver = "com.mysql.cj.jdbc.Driver", user = "root", password = "root")
...
fun sqlAdd(str: String): String{
    val strlist = str.split(" ")
    val table = strlist[1]
    val className = strlist[1]
    val stuName = strlist[2]
    val birMonth = strlist[3]
    val birDay = strlist[4]
    val stuQQ = strlist[5]
    val addCommand= String.format("INSERT INTO %s VALUES ('%s','%s','%s','%s');",table,className,stuName,birMonth,birDay,stuQQ)
    return addCommand
    //return "WrongCommand"
}